...
function FieldLabel({ htmlFor, children, required }) {
  return (
    <label htmlFor={htmlFor} style={{ display: 'block', fontSize: 16, fontWeight: 600, color: C.text, marginBottom: 6 }}>
      ...
      {options.map(opt => {
        ...
        return (
          <button
            ...
            style={{
              padding: '9px 18px', borderRadius: 24, cursor: 'pointer', fontSize: 17,
            ...
            {[
              ...
              <div key={row.label} style={{ paddingBottom: 10, marginBottom: 10, borderBottom: `1px solid ${C.border}` }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  ...
                  <span style={{ fontSize: 16, fontWeight: 800, color: row.accent ? C.blue : C.navy, marginLeft: 8 }}>{row.value}</span>
                </div>
        ...
        <div style={{ padding: '16px' }}>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ fontSize: 26, fontWeight: 900, color: C.navy, letterSpacing: '-0.5px', lineHeight: 1 }}>
              ${loanSummary.drawPayment}<span style={{ fontSize: 16, fontWeight: 600, color: C.muted }}>/mo</span>
            </div>
...
function StepperVertical({ step }) {
  return (
    <div style={{ width: 180, flexShrink: 0, paddingTop: 4 }}>
      ...
      <div style={{ fontSize: 17, fontWeight: 800, color: C.navy, marginBottom: 4 }}>Application progress</div>
          ...
          return (
            <div key={label} style={{ display: 'flex', gap: 12 }}>
              ...
              <div style={{ paddingTop: 4, paddingBottom: last ? 0 : 36 }}>
                <div style={{ fontSize: 16, fontWeight: active ? 700 : 500, color: active ? C.navy : done ? C.teal : C.muted, lineHeight: 1.3 }}>
                  {label}
                </div>
                {active && (
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 28, paddingTop: 20, borderTop: `1px solid ${C.border}` }}>
      <div style={{ display: 'flex', gap: 10 }}>
        {step > 1 && (
          <button onClick={onBack} style={{ padding: '11px 20px', borderRadius: 10, border: `1.5px solid ${C.border}`, background: 'none', fontSize: 17, fontWeight: 600, color: C.navy, cursor: 'pointer', fontFamily: 'inherit' }}>
            ← Back
          </button>
        )}
        <button style={{ padding: '11px 20px', borderRadius: 10, border: `1.5px solid ${C.border}`, background: 'none', fontSize: 17, fontWeight: 500, color: C.muted, cursor: 'pointer', fontFamily: 'inherit' }}>
          Save for later
        </button>
      </div>
      <button
...
function ScreenConfirmDetails({ state, setState, onNext }) {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 17, color: C.muted, margin: '0 0 28px' }}>Verify your property and personal details before we build your formal offer.</p>

      {/* ── Lien Attestation ── */}
      <fieldset style={{ border: 'none', margin: '0 0 24px', padding: 0 }}>
        <legend style={{ fontSize: 16, fontWeight: 800, color: C.blue, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 14 }}>Property & Liens</legend>

        <div style={{ background: C.offwhite, border: `1.5px solid ${C.border}`, borderRadius: 10, padding: '16px 18px', marginBottom: 14 }}>
          <div style={{ fontSize: 16, fontWeight: 700, color: C.navy, marginBottom: 6 }}>1482 Sunridge Drive, Sacramento, CA 95814</div>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
            <span style={{ fontSize: 16, color: C.muted }}>Estimated property value</span>
            <span style={{ fontSize: 16, fontWeight: 700, color: C.navy }}>~$680,000</span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
            <span style={{ fontSize: 16, color: C.muted }}>First mortgage balance</span>
            <span style={{ fontSize: 16, fontWeight: 700, color: C.navy }}>$412,000</span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <span style={{ fontSize: 16, color: C.muted }}>Available equity</span>
            <span style={{ fontSize: 16, fontWeight: 700, color: C.teal }}>~$268,000</span>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 6 }}>
          ...
          />
          <label htmlFor="lienAck" style={{ fontSize: 16, color: C.label, lineHeight: 1.5, cursor: 'pointer' }}>
      ...
      {/* ── Personal Details ── */}
      <fieldset style={{ border: 'none', margin: '0 0 24px', padding: 0 }}>
        <legend style={{ fontSize: 16, fontWeight: 800, color: C.blue, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 14 }}>Personal Details</legend>
      ...
      <fieldset style={{ border: 'none', margin: '0 0 8px', padding: 0 }}>
        <legend style={{ fontSize: 16, fontWeight: 800, color: C.blue, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 14 }}>Disclosures</legend>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
          ...
          />
          <label htmlFor="disclosures" style={{ fontSize: 16, color: C.label, lineHeight: 1.5, cursor: 'pointer' }}>
...
function ScreenLoanOptions({ state, setState, loanSummary, onBack, onNext }) {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 17, color: C.muted, margin: '0 0 28px' }}>Customize your draw amount, term, and origination fee to find the right balance for your budget.</p>

      {/* ── Draw Amount ── */}
      <fieldset style={{ border: 'none', margin: '0 0 24px', padding: 0 }}>
        <legend style={{ fontSize: 16, fontWeight: 800, color: C.blue, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 14 }}>Draw Amount</legend>
      ...
      {/* ── Term Selection ── */}
      <fieldset style={{ border: 'none', margin: '0 0 24px', padding: 0 }}>
        <legend style={{ fontSize: 16, fontWeight: 800, color: C.blue, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 14 }}>Loan Term</legend>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 8 }}>
          {TERM_OPTIONS.map(opt => {
            ...
            return (
              ...
              >
                <div style={{ fontSize: 18, fontWeight: 900, color: active ? C.blue : C.navy }}>{opt.label}</div>
      ...
      <fieldset style={{ border: 'none', margin: '0 0 24px', padding: 0 }}>
        <legend style={{ fontSize: 16, fontWeight: 800, color: C.blue, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 14 }}>Rate & Fee</legend>
            ...
            return (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <div>
                    <div style={{ fontSize: 17, fontWeight: 700, color: C.navy }}>{tier.rateLabel} rate — {tier.feeLabel} origination</div>
                    <div style={{ fontSize: 12, color: C.muted }}>{tier.label} option</div>
                  </div>
                </div>
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontSize: 16, fontWeight: 800, color: active ? C.blue : C.navy }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, padding: '14px 16px', background: C.offwhite, border: `1.5px solid ${C.border}`, borderRadius: 10, marginBottom: 8 }}>
        ...
        <label htmlFor="autopay" style={{ cursor: 'pointer' }}>
          <div style={{ fontSize: 17, fontWeight: 600, color: C.navy }}>Enroll in autopay</div>
...
function ScreenVerifyConfirm({ state, setState, onBack, onNext }) {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 17, color: C.muted, margin: '0 0 28px' }}>Complete income and identity verification, then authorize your full credit check.</p>

      {/* ── Income Verification ── */}
      <fieldset style={{ border: 'none', margin: '0 0 24px', padding: 0 }}>
        <legend style={{ fontSize: 16, fontWeight: 800, color: C.blue, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 14 }}>Income Verification</legend>
        ...
        {state.incomeConnected ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 16px', background: '#F0FDF4', border: '1.5px solid #86EFAC', borderRadius: 10, marginBottom: 12 }}>
            ...
            <div>
              <div style={{ fontSize: 17, fontWeight: 700, color: '#15803D' }}>Income verified</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 4 }}>
            {[
              ...
              >
                ...
                <div>
                  <div style={{ fontSize: 17, fontWeight: 600, color: C.navy }}>{opt.title}</div>
      ...
      <fieldset style={{ border: 'none', margin: '0 0 24px', padding: 0 }}>
        <legend style={{ fontSize: 16, fontWeight: 800, color: C.blue, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 14 }}>Identity Verification</legend>
        ...
        {state.idVerified ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 16px', background: '#F0FDF4', border: '1.5px solid #86EFAC', borderRadius: 10 }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#16A34A" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
            <div>
              <div style={{ fontSize: 17, fontWeight: 700, color: '#15803D' }}>ID verified</div>
          ...
          <div>
            <div style={{ background: C.offwhite, border: `1.5px dashed ${C.border}`, borderRadius: 10, padding: '24px', textAlign: 'center', marginBottom: 10 }}>
              ...
              <div style={{ fontSize: 17, fontWeight: 600, color: C.navy, marginBottom: 4 }}>Upload a photo of your ID</div>
              ...
              <button
                ...
                style={{ padding: '10px 24px', borderRadius: 8, border: `1.5px solid ${C.border}`, background: C.white, fontSize: 17, fontWeight: 600, color: C.navy, cursor: 'pointer', fontFamily: 'inherit' }}
              >
                Select Photo
              </button>
            </div>
      ...
      {/* ── HMDA ── */}
      <fieldset style={{ border: 'none', margin: '0 0 24px', padding: 0 }}>
        <legend style={{ fontSize: 16, fontWeight: 800, color: C.blue, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 6 }}>Government Monitoring (HMDA)</legend>
      ...
      <fieldset style={{ border: 'none', margin: 0, padding: 0 }}>
        <legend style={{ fontSize: 16, fontWeight: 800, color: C.blue, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 14 }}>Credit Authorization</legend>

        <div style={{ padding: '16px', background: '#FFFBEB', border: '1.5px solid #FCD34D', borderRadius: 10, marginBottom: 16 }}>
          <div style={{ fontSize: 16, fontWeight: 700, color: '#92400E', marginBottom: 4 }}>Hard credit pull ahead</div>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 6 }}>
          ...
          />
          <label htmlFor="hardPull" style={{ fontSize: 16, color: C.label, lineHeight: 1.5, cursor: 'pointer' }}>
...
function ScreenFinalSign({ state, setState, loanSummary, onBack, navigate }) {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 17, color: C.muted, margin: '0 0 28px' }}>Review your final terms and e-sign your loan documents to activate your HELOC.</p>
      ...
      <div style={{ background: C.offwhite, border: `1px solid ${C.border}`, borderRadius: 12, padding: '16px 20px', marginBottom: 24 }}>
        ...
        {[
          ...
          <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: i < 2 ? 8 : 0 }}>
            ...
            <span style={{ fontSize: 16, color: C.label, lineHeight: 1.5 }}>{item}</span>
          </div>
        ))}
      </div>
      ...
      <fieldset style={{ border: 'none', margin: '0 0 24px', padding: 0 }}>
        <legend style={{ fontSize: 16, fontWeight: 800, color: C.blue, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 14 }}>Disbursement Account</legend>
        {state.disbursementConnected ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 16px', background: '#F0FDF4', border: '1.5px solid #86EFAC', borderRadius: 10 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 17, fontWeight: 700, color: '#15803D' }}>Checking account connected</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            >
              ...
              <div>
                <div style={{ fontSize: 17, fontWeight: 600, color: C.navy }}>Connect via Plaid</div>
            ...
            >
              <span style={{ fontSize: 20 }}>📝</span>
              <div>
                <div style={{ fontSize: 17, fontWeight: 600, color: C.navy }}>Enter routing &amp; account number manually</div>
      ...
      {/* ── E-Sign documents ── */}
      <fieldset style={{ border: 'none', margin: '0 0 24px', padding: 0 }}>
        <legend style={{ fontSize: 16, fontWeight: 800, color: C.blue, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 14 }}>Sign Documents</legend>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {DOCS.map(doc => {
            ...
            return (
              ...
              >
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 17, fontWeight: 600, color: C.navy }}>{doc.label}</div>
                </div>
                <button
                  type="button"
