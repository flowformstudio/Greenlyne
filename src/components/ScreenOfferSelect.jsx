              ...
              const tiles = [
                {
                  ...
                  impact: `About ${formatCurrencyFull(deferAccrued)} gets added to your loan balance during that time`,
                  impactColor: '#92400e',
                ...
                },
                {
                  ...
                  impact: `Your loan stays at exactly ${formatCurrencyFull(enhPrinc)}`,
                  impactColor: '#016163',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(128px, 1fr))', gap: 10 }}>
              {redOptsList.map(({ id, label, months, desc }) => {
                ...
                return (
                  ...
                  >
                    <div style={{ fontSize: 16, fontWeight: 800, color: active ? '#254BCE' : '#001660', marginBottom: 4 }}>{label}</div>
