  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '20px 22px 22px', display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        {/* Title row + optional context pill */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4, flexWrap: 'wrap' }}>
          ...
          {isRecommended && (
            <span className="plan-context-pill" style={{
              fontSize: 10, fontWeight: 700, letterSpacing: '0.04em',
              color: T.blue, background: 'rgba(37,75,206,0.08)',
        ...
        <div style={{ fontSize: 12.5, color: T.muted, lineHeight: 1.5, marginBottom: 18, minHeight: 38 }}>
          {isRecommended
            ? '3 phases. Lowest payments early, higher payments after Year 5.'
            : 'One flat payment from day one. Build equity right away.'}
        </div>

        {/* ── PRIMARY HERO: Total paid in first 5 years ── */}
        <div className="plan-hero">
          ...
          {showSavings && (
            <div style={{ marginTop: 10 }}>
              <span className="plan-savings-badge" style={{
                display: 'inline-flex', alignItems: 'center', gap: 5,
                fontSize: 12, fontWeight: 700,
                color: '#047857',
        ...
        {/* ── Footer: APR · Total over full term (supporting info, smallest weight) ── */}
        <div className="plan-footer-meta" style={{
          display: 'flex', alignItems: 'baseline', justifyContent: 'space-between',
          marginTop: 14, marginBottom: 14,
          fontSize: 11, color: T.muted,
        }}>
          <span>APR <strong style={{ color: T.body, fontWeight: 600, ...NUM }}>{(offer.apr * 100).toFixed(2)}%</strong></span>
          <span style={{ width: 1, height: 12, background: T.line }} />
          <span>Total over full term <strong style={{ color: T.body, fontWeight: 600, ...NUM }}>{formatCurrencyFull(Math.round(offer.loanAmount))}</strong></span>
        </div>
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '20px 22px 22px', display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        {/* Sub-description */}
        <div style={{ fontSize: 12.5, color: 'rgba(255,255,255,0.6)', lineHeight: 1.5, marginBottom: 18, minHeight: 38 }}>
        ...
        {/* ── Footer: APR · Total over full term (small, supporting) ── */}
        <div className="plan-footer-meta" style={{
          display: 'flex', alignItems: 'baseline', justifyContent: 'space-between',
          marginTop: 14, marginBottom: 14,
          fontSize: 11, color: 'rgba(255,255,255,0.55)',
        }}>
          <span>APR <strong style={{ color: T.white, fontWeight: 600, ...NUM }}>{(offer.apr * 100).toFixed(2)}%</strong></span>
          <span style={{ width: 1, height: 12, background: 'rgba(255,255,255,0.18)' }} />
          <span>Total over full term <strong style={{ color: T.white, fontWeight: 600, ...NUM }}>{formatCurrencyFull(Math.round(offer.loanAmount))}</strong></span>
        </div>
